				...
				<div class="section_wrap_work">
					<div class="block_nav">
						<ul>
							...
							<li class="active"><a href="" data-page="portfolio" id="nav" data-other="1" data-name="фирменный стиль">фирменный стиль</a></li>
						</ul>
					</div>
					<div class="block_content">
						<div class="row" id="portfolio">
							...
							<div class="col-sm-12 col-md-6 portfolio-item wow fadeInDown" data-wow-delay=".3s">
								<a href="http://aibolit-shop.by/" target="_blank" rel="nofollow" class="portfolio-item-link">
									<div class="block_item"> <img src="/assets/images/aibolit-background.jpg" alt="">
										<div class="overlay"></div>
										<div class="block_inner_wrapper">
											<div class="block_inner_text">
												<div class="top">
													<h2>Aibolit-shop</h2> </div>
												<div class="absolute">
													<p class="transparent">
														<p>Разработали интернет магазин по продаже товаров для животных</p>
													</p>
												</div>
											</div>
										</div>
										<div class="block_tags"> <span>разработка сайтов</span> <span>1С Битрикс</span> <span>фирменный стиль</span> </div>
									</div>
								</a>
							</div>
							<div class="col-sm-12 col-md-6 portfolio-item wow fadeInDown" data-wow-delay=".3s">
								<a href="http://xn--80adi6afdifs.xn--90ais/" target="_blank" rel="nofollow" class="portfolio-item-link">
									<div class="block_item"> <img src="/assets/images/supernova-background.jpg" alt="">
										<div class="overlay"></div>
										<div class="block_inner_wrapper">
											<div class="block_inner_text">
												<div class="top">
												...
												<div class="absolute">
													<p class="transparent">
														<p>Разработали имиджевый сайт производителя кухонь и шкафов-купе</p>
													</p>
												</div>
											</div>
										</div>
										<div class="block_tags"> <span>разработка сайтов</span> <span>продвижение сайтов</span> <span>фирменный стиль</span> </div>
									</div>
								</a>
							</div>
							<div class="col-sm-12 col-md-6 portfolio-item wow fadeInDown" data-wow-delay=".3s">
